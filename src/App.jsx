...
const TOUR_STEPS = [
  {
    title: "Welcome to DNO Application Manager",
    text: "This is the dashboard — it shows all your applications at a glance. You are in Demo Mode so no real data will be saved.",
  },
  {
    title: "Stats Overview",
    text: "These cards show a summary of your applications by status — total, draft, submitted and approved.",
  },
  {
    title: "Filter by DNO or Status",
    text: "Use these dropdowns to filter applications by DNO or status — really useful as your list grows.",
  },
  {
    title: "PDF Download",
    text: "Click the green PDF button to download a formatted application PDF ready to print or email.",
  },
  {
    title: "Edit Application",
    text: "Click the blue Edit button to update any application details. The DNO updates automatically if you change the postcode.",
  },
  {
    title: "Application Timeline",
    text: "Click the teal Timeline button to track status changes and add internal notes on each application.",
  },
  {
    title: "Load Calculator",
    text: "Click the orange Load Calc button to calculate G98/G99 status, export limits and maximum demand — includes live ENA TTR product search.",
  },
  {
    title: "Submit to DNO",
    text: "Click the purple Submit button to open the correct DNO portal. When ENA Connect Direct API is active this will submit automatically.",
  },
  {
    title: "Share with Customer",
    text: "Click the pink Share button to copy a unique customer portal link — customers can track their application status without logging in.",
  },
  {
    title: "You're all set!",
    text: "Exit demo mode by clicking the X on the orange banner. Share this demo with anyone by adding ?demo=true to your URL.",
  },
];

// ─── ENA Connect Direct ───────────────────────────────────────────────────────
// Paste your credentials here when received from ENA
const ENA_CONFIG = {
  enabled: false, // Set to true when credentials arrive
  authorization: "", // Paste Authorization header value here
  apiKey: "", // Paste X-API-Key value here
  tenantId: "", // Paste X-Tenant-Id value here
  baseUrl: "https://hybrid.connect-direct.energynetworks.org/lct/v1",
};
        ...
        <div className="bg-orange-500 text-white px-6 py-2 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm">
              No data will be saved. Sample applications shown.
            </span>
            <button
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-6">
            ...
            <div className="flex gap-1 mb-4">
              {TOUR_STEPS.map((_, i) => (
                <div
                  key={i}
                  className={`h-1.5 flex-1 rounded-full ${i <= tourStep ? "bg-orange-500" : "bg-gray-200"}`}
                />
              ))}
            </div>
