...
const TOUR_STEPS = [
  ...
  { title:'Submit to DNO', text:'Click the purple Submit button to open the correct DNO portal. When ENA Connect Direct API is active this will submit automatically.' },
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {!demoMode && (
        <div className={`px-6 py-1.5 text-xs text-center font-medium ${ENA_CONFIG.enabled ? 'bg-green-600 text-white' : 'bg-yellow-50 text-yellow-700 border-b border-yellow-200'}`}>
          {ENA_CONFIG.enabled
            ? '🟢 ENA Connect Direct — Live submissions enabled'
            : '🟡 ENA Connect Direct — Awaiting API credentials. Submissions will open DNO portal manually.'}
        </div>
      )}
